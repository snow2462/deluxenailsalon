...
if (!class_exists('SlideshowckListTable')) {
	require_once(SLIDESHOWCK_PATH . '/includes/class.list-table.php');
}

if (!class_exists('SlideshowckListTableGeneral')) {
	require_once(SLIDESHOWCK_PATH . '/includes/class.list-table.general.php');
}
...
<div class="wrap">
	...
	<img src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/logo_slideshowck_64.png" style="float:right; margin: 0px 5px;" />
	<h2>Slideshow CK
<?php
