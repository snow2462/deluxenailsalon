...
<div id="slideshowedition">
	...
	<div class="tabck menustyles current" id="tab_images">
		...
		if ($this->ispro) {
			...
			echo $this->get_field('select', 'slides_sources', $this->get_param('slides_sources', 'slidemanager'), 'slideshowckparams', $options_slides_sources, false, 'onchange="ckShowSlidesSources();"');
		} else { ?>
			<input type="hidden" name="slides_sources" id="slides_sources" value="slidemanager" />
		<?php
		}
		...
		<div class="slides_source" data-source="slidemanager">
			<div id="ckslides">
				...
				<div>
					...
					<?php echo $this->get_field('text', 'importfoldername', '') ?>
	...
	<div class="tabck menustyles saveparam" id="tab_styles">
		...
		<div>
			...
			<?php echo $this->get_field('select', 'theme', $this->get_param('theme'), 'theme', SlideshowckFolder::folders(SLIDESHOWCK_PATH . '/themes'), true); ?>
		</div>
		<div>
...
<?php echo $this->get_field('text', 'caption_bgopacity', $this->get_param('caption_bgopacity')) ?>
			...
			<div>
				...
				<span style="width:35px;" caption="<?php _e('Top', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_margintop', $this->get_param('caption_margintop')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/margin_right.png" /></span>
				<span style="width:35px;" caption="<?php _e('Right', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_marginright', $this->get_param('caption_marginright')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/margin_bottom.png" /></span>
				<span style="width:35px;" caption="<?php _e('Bottom', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_marginbottom', $this->get_param('caption_marginbottom')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/margin_left.png" /></span>
				<span style="width:35px;" caption="<?php _e('Left', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_marginleft', $this->get_param('caption_marginleft')) ?></span>
			</div>
			<div>
				...
				<span style="width:35px;" caption="<?php _e('Top', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_paddingtop', $this->get_param('caption_paddingtop')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/padding_right.png" /></span>
				<span style="width:35px;" caption="<?php _e('Right', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_paddingright', $this->get_param('caption_paddingright')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/padding_bottom.png" /></span>
				<span style="width:35px;" caption="<?php _e('Bottom', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_paddingbottom', $this->get_param('caption_paddingbottom')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/padding_left.png" /></span>
				<span style="width:35px;" caption="<?php _e('Left', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_paddingleft', $this->get_param('caption_paddingleft')) ?></span>
			</div>
			<div>
				...
				<span style="width:35px;" title="<?php _e('Top Left', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_roundedcornerstl', $this->get_param('caption_roundedcornerstl')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/border_radius_tr.png" /></span>
				<span style="width:35px;" title="<?php _e('Top Right', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_roundedcornerstr', $this->get_param('caption_roundedcornerstr')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/border_radius_br.png" /></span>
				<span style="width:35px;" title="<?php _e('Bottom Right', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_roundedcornersbr', $this->get_param('caption_roundedcornersbr')) ?></span>
				<span><img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/border_radius_bl.png" /></span>
				<span style="width:35px;" title="<?php _e('Bottom Left', 'slideshow-ck'); ?>"><?php echo $this->get_field('text', 'caption_roundedcornersbl', $this->get_param('caption_roundedcornersbl')) ?></span>
			</div>
			<div>
...
?>
		...
		<div>
			...
			<img class="iconck" src="<?php echo SLIDESHOWCK_MEDIA_URL ?>/images/arrow_out.png" />
<?php
echo $this->get_field('text', 'container', $this->get_param('container'));
?>
