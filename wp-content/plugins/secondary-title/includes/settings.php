                              ...
                              <div class="post-types">
                                 <?php
                                    ...
                                    foreach((array)$post_types as $post_type) {
                                       ...
                                       $label = sprintf(_n("1 post", "%s posts", $post_type_posts_count, "secondary_title"), $post_type_posts_count);
                                       ?>
                                       <p class="post-type">
                        ...
                        <tr>
                           <th>
                              <label for="input-field-position-top">
                                 ...
                                 <?php _e("Input field", "secondary_title"); ?>:
                              </label>
                           </th>
                           <td>
                              <div class="radios">
                              ...
                              <p class="description">
                                 <?php _e("Determines the position of the secondary title input field on add/edit post pages inside the dashboard.", TEXTDOMAIN); ?>
                              </p>
                           </td>
                        </tr>
                        <tr>
