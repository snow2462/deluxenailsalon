...
if ( $update_data['counts']['total'] ) {
	$submenu['front-page.php'][10] = array( sprintf( __( 'Updates %s' ), "<span class='update-plugins count-{$update_data['counts']['total']}'><span class='update-count'>" . number_format_i18n( $update_data['counts']['total'] ) . "</span></span>" ), 'update_core', 'update-core.php' );
} else {
	$submenu['front-page.php'][10] = array( __( 'Updates' ), 'update_core', 'update-core.php' );
}

$submenu['front-page.php'][15] = array( __( 'Upgrade Network' ), 'manage_network', 'upgrade.php' );
